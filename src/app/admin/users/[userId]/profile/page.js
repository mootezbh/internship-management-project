    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-600 dark:text-slate-300 mb-4">The user profile you&apos;re looking for doesn&apos;t exist.</p>
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600 dark:text-slate-300">{user.name}</p>
        </div>
        {/* Main Content */}
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-slate-900 dark:text-white">{user.name || 'Not provided'}</p>
                  </div>
                  <div>
            ...
            <Card className="border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
              ...
              <CardContent className="space-y-4">
                ...
                {user.education && (
                  <div>
                    <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Additional Education</label>
                    <p className="text-slate-900 dark:text-white mt-1">{user.education}</p>
                  </div>
                )}
              </CardContent>
            </Card>
            ...
            <Card className="border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
              ...
              <CardContent className="space-y-4">
                ...
                {user.interests && user.interests.length > 0 && (
                  <div>
                    <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Interests</label>
                    <div className="flex flex-wrap gap-2 mt-2">
                ...
                {user.preferredFields && user.preferredFields.length > 0 && (
                  <div>
                    <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Preferred Fields</label>
                    <div className="flex flex-wrap gap-2 mt-2">
              ...
              <CardContent className="space-y-3">
                ...
                {!user.cvUrl && (
                  <div className="text-center py-4">
                    <p className="text-slate-500 dark:text-slate-400 text-sm">No CV uploaded</p>
                  </div>
                )}
                {user.linkedinUrl && (
                  <Button
                    ...
                    variant="outline"
                    className="w-full justify-start border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300"
                  >
